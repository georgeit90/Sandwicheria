            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <div class="col-lg-12">
                       ...
                       <form method="post" name="AgregarPlatillo" id = "FormEditarPlatillo" action='<?php echo URL ;?>platillos/guardar/1'>
                        <div class="panel panel-default">
						 <div class="panel-body">
							<div class="form-group">
							    <input type="hidden" id="txtIdPlatillo" name="idPlatillo" class="form-control">
                                <label>Nombre</label>
                                <input type="text" id="txtNombre" name="nombre" class="form-control">
                            </div>
							<div class="form-group">
                                <label>Descripcion</label>
                                <textarea rows="3" class="form-control" id="txtDescrip" name="descripcion"></textarea>
                            </div>
							<div class="form-group">
