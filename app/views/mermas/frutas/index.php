                ...
                <div class="row">
                   ...
                   <div class="col-lg-12">
                         ...
                         <button id="Add" class="btn btn-default" onclick="Add()" >Add</button>
                          <form method="post" name="MermaFrutas" id = "FormMermaFrutas" action='<?php echo URL ;?>mermafrutas/guardar/'>
                        <div class="table-responsive">
                            <table id="tblMermaFrutas" class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr>
						              <th>idMermaFrutas</th>
									  <th>frutas</th>
