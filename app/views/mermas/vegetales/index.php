                ...
                <div class="row">
                   ...
                   <div class="col-lg-12">
                         ...
                         <button id="Add" class="btn btn-default" onclick="Add()" >Add</button>
                          <form method="post" name="MermaVegetales" id = "FormMermaVegetales" action='<?php echo URL ;?>mermavegetales/guardar/'>
                        <div class="table-responsive">
                            <table id="tblMermaVegetales" class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr>
						              <th>idMermaVegetales</th>
									  <th>vegetales</th>
									  <th>fechaCreacion</th>
									  <th>cantidad</th>
						              <th></th>
