                ...
                <div class="row">
                   ...
                   <div class="col-lg-12">
                         ...
                         <button id="Add" class="btn btn-default" onclick="Add()" >Add</button>
                          <form method="post" name="Condimentos" id = "FormCondimentos" action='<?php echo URL ;?>condimentos/guardar/'>
                        <div class="table-responsive">
                            <table id="tblCondimentos" class="table table-bordered table-hover table-striped">
                                <thead>
                                    <tr>
						              <th>idCondimentos</th>
						              <th>descripcion</th>
