...
function List()
{
	 ...
	 $.get('carnes/List',function(o){
		 
		 $('#tblCarnes').append('<tbody>');
		 $(jQuery.parseJSON(o)).each(function() {  
		 $('#tblCarnes').append("<tr id='tr_"+this.idCarne+"'><th><a href='#' class='select' rel='"+this.idUsuario+"'>"+this.idUsuario+"</a></th><th class='nombre'>"
		...
		+this.rol+"<th class='edit'><a href='#' class='edit' rel='"+this.idUsuario+"'><img alt='200x16' src='public/images/edit.gif' ></a></th>" +
				"<th class='delete'><a href='#' class='delete' rel='"+this.idUsuario+"'><img alt='200x16' src='public/images/delete.png' ></a></th></tr>");
		 });
		  $('#tblCarnes').append('<tbody>');
