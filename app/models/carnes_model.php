...
class Carnes_Model extends Model {
	...
	parent::__construct(); 
		...
		$cantidad=$_POST["cantidad"];
		$unidadMedida=$_POST["unidadMedida"];
	    //$str="UPDATE carne SET descripcion ='".$descripcion."' ,cantidad =".$cantidad." ,unidadMedida =".$unidadMedida." where idCarne =".$idCarne;
		$sth= $this->db->prepare("UPDATE carne SET descripcion ='".$descripcion."' ,cantidad =".$cantidad." ,unidadMedida =".$unidadMedida." where idCarne =".$idCarne); 
		$sth->execute(); 
